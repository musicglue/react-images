...
var Lightbox = (function (_Component) {
	...
	_createClass(Lightbox, [{
		...
		key: 'onSwipingLeft',
		value: function onSwipingLeft(e, deltaX, absX, velocity) {
			console.log('swipeLeft: deltaX ' + deltaX + '  absX: ' + absX + '  velocity ' + velocity);
		}
	}, {
		key: 'onSwipingRight',
		value: function onSwipingRight(e, deltaX, absX, velocity) {
			console.log('swipeRight: deltaX ' + deltaX + '  absX: ' + absX + '  velocity ' + velocity);
		}
